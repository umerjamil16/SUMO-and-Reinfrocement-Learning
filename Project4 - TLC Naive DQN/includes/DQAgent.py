...
import numpy as np
import torch as T
from includes.neural_network import LinearDeepQNetwork
 
class DQAgent(object):
    """
        This is single agent class.
    """
    def __init__(self, input_dims=8, n_actions=2, lr=0.0001, gamma=0.99,\
                    epsilon = 1.0, eps_dec=1e-4, eps_min=0.01, TLC_name="gneJ26"):
